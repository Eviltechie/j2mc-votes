...
public class Votes {
     ...
     * @param choices {@link List} of possible answers
     * @param id A {@link UUID} that the {@link VoteTallyEvent} will contain to easily see if this is your event.
     ...
     */
    public void newVote(String question, List<String> choices, UUID id, int time, boolean publicVotes, boolean cancelable) throws VoteAlreadyInProgressException, VoteNotLoadedException {
     ...
     * @param question The question
     * @param choices A {@link HashMap} of possible choices to vote for. The string (key) is the representation of the object (value) which will be used as a choice.
     * @param id A {@link UUID} that the {@link VoteTallyEvent} will contain to easily see if this is your event.
     * @param time How long the vote should run for in seconds.
     * @param publicVotes Whether or not to announce who voted for what
     * @param cancelable Whether or not the vote can be canceled
